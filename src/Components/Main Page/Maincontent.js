...
function Maincontent() {
  ...
  return (
    <>
      ...
      <div
        className={`${
          showUp ? `top-[350px]` : ` top-[738px]`
        } w-[300px] cursor-pointer p-[2px]  bg-white z-50 fixed bottom-0  right-0 h-[50px]  rounded-tl-md`}
      >
        <div
          onClick={(e) => rollup()}
        ...
        >
          <div onClick={(e) => rollup()} className="flex space-x-3">
            <img
              ...
              alt="profile_image"
            />
            <p onClick={(e) => rollup()} className="text-[14px] font-bold">
              Messaging
            </p>
          </div>
        ...
        <div
          className={`${
            rollup ? `h-[400px]` : `top-1`
          }  bg-white  mt-[2px] w-[850px] `}
        >
          <hr className="-mt-1" />
          {/* search */}
          <div className="pl-2 pr-2 pt-1 pb-1">
            <div className="bg-gray-200 w-[280px] mt-3 rounded-[9px] p-1">
              ...
              <input
                type="text"
                placeholder="search"
                className="bg-gray-200 w-[220px] outline-none text-[14px] p-1"
              />
              <TuneIcon />
            </div>
          </div>
          ...
          <div className="mt-2 flex hover:bg-gray-200 p-2 cursor-pointer">
            <div>
              <img
                ...
                src="https://thumbs.dreamstime.com/b/%D0%BF%D0%B5%D1%87%D0%B0%D1%82%D1%8C-male-face-avatar-man-beard-suit-shirt-necktie-portrait-businessman-icon-vector-illustration-189004563.jpg"
                alt="profile_image"
              />
            </div>
            <div>
              <div className="flex justify-between space-x-[80px] items-center">
                <p className="font-bold text-[14px] -mt-3 ml-2">Paul Omondi</p>
                <p className="font-bold text-[12px]">Feb 12</p>
              </div>
              <p className="flex-col -mt-2 text-[12px] ml-2">
                How are you doing Abdu ?
              </p>
              <hr />
            </div>
          </div>
          ...
          <div className="mt-2 flex hover:bg-gray-200 p-2 cursor-pointer">
            ...
            <div>
              <div className="flex justify-between space-x-[110px] items-center">
                <p className="font-bold text-[14px] -mt-3 ml-2">Max G</p>
          ...
          <div className="mt-2 flex hover:bg-gray-200 p-2 cursor-pointer">
            ...
            <div>
              <div className="flex justify-between space-x-[80px] items-center">
                <p className="font-bold text-[14px] -mt-3 ml-2">Loise K</p>
          ...
          <div className="mt-2 flex hover:bg-gray-200 p-2 cursor-pointer">
            ...
            <div>
              <div className="flex justify-between space-x-[80px] items-center">
                <p className="font-bold text-[14px] ml-2">Maggie M</p>
